...
+---------+-------------------------+------------+--------+
| Account |       ResourceId        |   State    | Type   |
+---------+-------------------------+------------+--------+
|  None   |  vpc-06dfa65f4c3960a9b  |  available |  vpc   |
|  None   |  vpc-0f40843575a928f6c  |  available |  vpc   |
|  None   |  vpc-087ad34d973439867  |  available |  vpc   |
+---------+-------------------------+------------+--------+
...
|    CIDR     |  State   |    Type      |
+-------------+----------+--------------+
|  10.0.0.0/24|  active  |  propagated  |
|  10.0.1.0/24|  active  |  propagated  |
|  10.0.2.0/24|  active  |  propagated  |
+-------------+----------+--------------+
...
+--------------+-------------------------+-------+
|     CIDR     |       ResourceId        | Type  |
+--------------+-------------------------+-------+
|  10.0.0.0/24 |  vpc-087ad34d973439867  |  vpc  |
+--------------+-------------------------+-------+
...
|     CIDR     |          ResourceId           |   Type     |
+--------------+-------------------------------+------------+
|  10.0.0.0/24 |  ipam-pool-04a0449cdd3e15a7a  |  ipam-pool |
|  10.0.1.0/24 |  ipam-pool-0d9f464919796dfa6  |  ipam-pool |
|  10.0.2.0/24 |  ipam-pool-0da7d72722cc01006  |  ipam-pool |
+--------------+-------------------------------+------------+
...
|     CIDR     |          ResourceId           |   Type     |
+--------------+-------------------------------+------------+
|  10.0.0.0/16 |  ipam-pool-05f26cd57a6dbb9e0  |  ipam-pool |
+--------------+-------------------------------+------------+
...
|     CIDR     |       ResourceId        | Type  |
+--------------+-------------------------+-------+
|  10.0.1.0/24 |  vpc-06dfa65f4c3960a9b  |  vpc  |
+--------------+-------------------------+-------+
...
|     CIDR     |       ResourceId        | Type  |
+--------------+-------------------------+-------+
|  10.0.2.0/24 |  vpc-0f40843575a928f6c  |  vpc  |
+--------------+-------------------------+-------+
...
+------------+---------------+------------+-----------------------------+
|  us-west-2a|  10.0.0.0/26  |  available |  subnet-0702dde763148ed68   |
|  us-west-2b|  10.0.0.64/26 |  available |  subnet-06991cbf716c0c679   |
+------------+---------------+------------+-----------------------------+
...
|     AZ     |     CIDR      |   State    |          SubnetId           |
+------------+---------------+------------+-----------------------------+
|  us-west-2b|  10.0.1.64/26 |  available |  subnet-032e659d9216f5227   |
|  us-west-2a|  10.0.1.0/26  |  available |  subnet-0bf88878293b363cb   |
+------------+---------------+------------+-----------------------------+
...
|     AZ     |     CIDR      |   State    |          SubnetId           |
+------------+---------------+------------+-----------------------------+
|  us-west-2b|  10.0.2.64/26 |  available |  subnet-0ef8f2cfd99c9b2c6   |
|  us-west-2a|  10.0.2.0/26  |  available |  subnet-007331519954b9c81   |
+------------+---------------+------------+-----------------------------+
